...
Partial Module CLI
    ...
    <Usage("/performance_counter -u <mysql_user_name> -p <password> [--host <mysql_host, default=localhost> --port <mysql_port, default=3306> --http <monitor_output, default=86> --save_size <max_pool_size, default=1000>]")>
    Public Function PerformanceCounter(args As CommandLine) As Integer
        ...
        Dim save_size As Integer = args("--save_size") Or 1000
        ...
        Dim monitor As New Logger(uri, echo:=False, queue_size:=save_size)
        ...
        Call VBDebugger.EchoLine($"use api 'http://localhost:{http}/get/' for get mysql server performance counter data.")
        Call service.Run()
